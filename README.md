# このレポジトリでの翻訳は終了しました。現在は https://github.com/ionic-jp/capacitor-site で行っておりますのでこちらをご利用ください。
...
# Capacitor 日本語ドキュメンテーション

Capacitorの公式ドキュメントを日本語に翻訳するためのレポジトリです。
コンテンツは [capacitor.ionicframework.jp](https://capacitor.ionicframework.jp) で公開しています。
